    ...
    <div className="min-h-screen bg-rose-50">
      ...
      <section className="relative h-screen">
        ...
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-white px-4">
          ...
          <p className="text-lg text-rose-200 text-center">
            Bøfjordvegen 23, Hyllestad Kommune
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 text-center leading-relaxed">
            <p className="text-xl">
              Ungdomshuset skal være et inkluderende møtested hvor alle kan bli med, uansett hvem de er.
              Her skaper vi et trygt og varmt miljø for aktiviteter, opplevelser og fellesskap.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Romslig spisesal for måltider og sosiale sammenkomster
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-rose-50 rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Vakre turstier og fjellområder perfekt for turgåing og naturopplevelser.
                  Nyt den spektakulære naturen i Sogn og Fjordane.
                </p>
              </div>
            </div>
            ...
            <div className="bg-rose-50 rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Fine badeplasser i nærområdet, perfekt for varme sommerdager ved sjøen
            ...
            <div className="bg-rose-50 rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Flott feriested med fisking og båtutleie. Perfekt for en dag på sjøen
                  eller en lenger fisketur med venner og familie.
                </p>
              </div>
            </div>
            ...
            <div className="bg-rose-50 rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Historisk park med fascinerende kvernsteiner som forteller historien om
                  områdets rike kulturarv og steinbruddshistorie.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-4 bg-rose-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Vi leier ut lokaler til alle typer arrangementer
            </p>
          </div>
